...
async function main() {
  ...
  const pendingUser = await prisma.user.upsert({
    ...
    create: {
      ...
      isEmailConfirmed: true,
      isActivated: false,
      bio: 'I am waiting for activation.',
    },
  });
  ...
  await prisma.course.update({
    ...
    data: {
      students: {
        connect: [{ id: admin.id }, { id: instructor.id }, { id: student.id }],
      },
    },
  });
  ...
  const videoUrl =
    'https://triunfars-bucket.s3.us-east-2.amazonaws.com/video1.mp4';
  ...
  await prisma.lesson.create({
    data: {
      ...
      slug: 'what-is-nestjs',
      description:
        'An introduction to the NestJS framework and its core concepts.',
      content:
  ...
  await prisma.lesson.create({
    data: {
      ...
      description:
        'Learn how to set up your development environment for NestJS.',
      content:
        'In this lesson, we will install Node.js, npm, and create our first NestJS project.',
      type: LessonType.VIDEO,
      source: videoUrl,
      sectionId: section1.id,
    },
  ...
  await prisma.lesson.create({
    data: {
      ...
      description:
        'Learn about services and the powerful dependency injection system.',
      content:
        'Services contain business logic and can be injected into controllers and other services.',
      type: LessonType.VIDEO,
      source: videoUrl,
      sectionId: section2.id,
    },
  ...
  await prisma.lesson.create({
    data: {
      ...
      content:
        'Learn how to create GET, POST, PUT, and DELETE endpoints for your API.',
      type: LessonType.VIDEO,
      source: videoUrl,
  ...
  await prisma.lesson.create({
    data: {
      ...
      content:
        'DTOs (Data Transfer Objects) help us validate and transform incoming data.',
      type: LessonType.VIDEO,
      source: videoUrl,
      sectionId: section3.id,
    },
